    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(related_name='wallet_members', through='wallet.Balance', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='balance',
